    ...
    async def start(self, button: disnake.ui.Button, inter: disnake.MessageInteraction):
        embeds = [
            disnake.Embed(
                ...
                url="https://media.discordapp.net/attachments/925435932532936714/992768683887829073/Screenshot_82.png?width=840&height=473"),
            disnake.Embed(
    ...
    async def select_roles(self, button: disnake.ui.Button, inter: disnake.MessageInteraction):
        embeds = [
            disnake.Embed(title=":zany_face: Выбрать роли",
                          description="но нажмите на одну из категорий ролей ниже, чтобы добавить роли, применимые к вам.")
        ]
